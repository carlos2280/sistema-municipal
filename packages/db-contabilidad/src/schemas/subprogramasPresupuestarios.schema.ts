...
export type SubprogramaPresupuestario = typeof subprogramasPresupuestarios.$inferSelect;
export type NewSubprogramaPresupuestario = typeof subprogramasPresupuestarios.$inferInsert;
export type SubprogramaPresupuestarioUpdate = Partial<NewSubprogramaPresupuestario>;
