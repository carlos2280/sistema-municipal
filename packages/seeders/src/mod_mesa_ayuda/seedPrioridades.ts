...
/**
 * Seedea el catalogo global de prioridades de mesa_ayuda en la DB transversal.
 *
 * Idempotente: usa onConflictDoNothing sobre el campo unico `codigo`.
 */
export async function seedPrioridades(
  ...
  console.log(
    `  Prioridades mesa_ayuda: ${PRIORIDADES.length} registros (onConflictDoNothing)`,
  );
}
