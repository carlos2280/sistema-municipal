...
import { Pool } from "pg";
import { municipalidades } from "../database/platform/schemas/municipalidades.schema";
import { modulos } from "../database/platform/schemas/modulos.schema";
import { suscripciones } from "../database/platform/schemas/suscripciones.schema";
import { suscripcionHistorial } from "../database/platform/schemas/suscripcionHistorial.schema";
...
async function seed() {
  ...
  await db.transaction(async (tx) => {
    ...
    // 3. Suscripciones: default tiene ambos módulos activos
