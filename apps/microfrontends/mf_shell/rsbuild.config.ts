    ...
    plugins: [
      ...
      pluginModuleFederation({
        ...
        shared: {
          ...
          '@mui/material': { singleton: true, eager: true, requiredVersion: false, version: '7.3.7' },
          '@mui/icons-material': { singleton: true, eager: true, requiredVersion: false, version: '7.3.7' },
          '@emotion/react': { singleton: true, eager: true, requiredVersion: false, version: '11.14.0' },
          '@emotion/styled': { singleton: true, eager: true, requiredVersion: false, version: '11.14.0' },
