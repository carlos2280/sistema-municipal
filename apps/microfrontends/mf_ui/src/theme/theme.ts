...
export const MODULE_ACCENTS = {
  home:         { main: '#818CF8', rgb: '129,140,248', tint: '#0B0B0F', name: 'Inicio' },
  contabilidad: { main: '#34D399', rgb: '52,211,153',  tint: '#0B0F0D', name: 'Contabilidad' },
  tesoreria:    { main: '#2DD4BF', rgb: '45,212,191',  tint: '#0B0E0E', name: 'Tesorería' },
  rrhh:         { main: '#FBBF24', rgb: '251,191,36',  tint: '#0F0E0B', name: 'RRHH' },
  obras:        { main: '#60A5FA', rgb: '96,165,250',  tint: '#0B0D0F', name: 'Obras Públicas' },
  catastro:     { main: '#F472B6', rgb: '244,114,182', tint: '#0F0B0E', name: 'Catastro' },
  config:       { main: '#A78BFA', rgb: '167,139,250', tint: '#0D0B0F', name: 'Configuración' },
  chat:         { main: '#C084FC', rgb: '192,132,252', tint: '#0E0B0F', name: 'Mensajería' },
} as const;
