    ...
    plugins: [
      ...
      pluginModuleFederation({
        ...
        shared: {
          ...
          '@emotion/react': { singleton: true, requiredVersion: false, version: '11.14.0' },
          '@emotion/styled': { singleton: true, requiredVersion: false, version: '11.14.0' },
