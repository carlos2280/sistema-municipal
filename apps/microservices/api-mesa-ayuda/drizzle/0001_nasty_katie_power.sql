CREATE TYPE "public"."ticket_estado" AS ENUM('abierto', 'en_progreso', 'en_espera', 'resuelto', 'cerrado');--> statement-breakpoint
...
CREATE INDEX "idx_tickets_fecha_limite" ON "mesa_ayuda"."tickets" USING btree ("fecha_limite") WHERE "mesa_ayuda"."tickets"."estado" NOT IN ('resuelto', 'cerrado');--> statement-breakpoint
...
CREATE INDEX "idx_historial_ticket" ON "mesa_ayuda"."historial_estados" USING btree ("ticket_id");
